        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {achievements.map((achievement, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${achievement.gradient} opacity-10 rounded-3xl transform transition-all duration-500 group-hover:opacity-20`}
              />
              ...
              <div className="relative bg-white/90 backdrop-blur-lg p-12 rounded-3xl border-2 border-orange-100 shadow-xl transition-all duration-500 group-hover:shadow-2xl group-hover:border-orange-200">
                ...
                <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
                  <div
                    className={`p-4 rounded-2xl bg-gradient-to-br ${achievement.gradient} text-white shadow-lg`}
                  >
                    {achievement.icon}
                  </div>
                </div>
