...
import { Phone, MapPin, Calendar, ArrowRight, Star, Trophy, Mountain, Users, Clock, CheckCircle, Facebook, Instagram, Mail, Twitter, Youtube } from 'lucide-react';
...
const HomePage: React.FC<HomePageProps> = ({ treks, imagesByTrekId, testimonials }) => {
    return (
            ...
            <footer className="bg-gray-900 text-white pt-20 pb-10">
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                ...
                                <li><a href="#" className="text-gray-400 hover:text-orange-500 transition-colors">Our Treks</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-orange-500 transition-colors">Equipment Rental</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-orange-500 transition-colors">Travel Services</a></li>
                            </ul>
                        </div>
                    ...
                    <div className="pt-8 border-t border-gray-800 text-center text-gray-400">
                        <p>&copy; {new Date().getFullYear()} Dream Treks. All rights reserved.</p>
                    </div>
                </div>
            </footer>
